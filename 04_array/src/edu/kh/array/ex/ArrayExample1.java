...
public class ArrayExample1 {
	...
	public void ex1() {
		...
		//int[] arr2 = new double[5]; -> 다른 자료형 (연산 불가능)
	...
	public void ex3() {
		...
		// double[] 자료형 참조변수 arr을 stack 영역에 생성하고
		// arr에 heap 영역에 새로 생성된 double 5칸짜리 double[]의 시작 주소를 대입
		double sum = 0;
		...
		System.out.printf("평균 : %.2f cm",sum / arr.length);
