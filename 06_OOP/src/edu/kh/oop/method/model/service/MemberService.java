...
public class MemberService {
	...
	public String login() {
		...
		if(memberId.equals(memberInfo.getMemberId()) && memberPw.equals(memberInfo.getMemberPw())) {
			// 입력받은 memberId와 memberInfo 필드에서 참조중인
			// Member객체의 memberId가 같은지 확인
			// &&
			// 입력받은 memberPw와 memberInfo 필드에서 참조중인
			// Member객체의 memberPw가 같은지 확인
	...
	public String selectMember() {
		...
		String answer = "이름 : " + loginMember.getMemberName() + "\n아이디 : " + loginMember.getMemberId() + 
