...
public class StudentService {
	...
	// ArrayList() 기본생성자 : 기본 크기 10칸 리스트 생성
...
//	private List studentList = new LinkedList(); // 추가, 수정, 삭제에 효율적
	...
	public StudentService() {// 기본생성자
		...
		studentList.add(new Student("김종조", 25, "서울시 중랑구", 'M', 85));
		studentList.add(new Student("고구마", 15, "경북 창원시", 'F', 95));
		studentList.add(new Student("양파링", 30, "충남 아산", 'M', 80));
	...
	public void ex() {
		...
		// List.add(Object o) : 리스트에 객체를 추가
		// * 매개변수 타입이 Object == 모든 객체 매개변수로 전달할 수 있음
		studentList.add(new Student()); // 0번 인덱스에 Student 객체가 들어감
//		studentList.add(sc); // 1번 인덱스에 Scanner 객체가 들어감
...
//		System.out.println( studentList.get(3) );
	...
	public void selectAll() {
		...
		for(Student std : studentList) {
			// std에는 for문 반복 시 마다 0,1,2....마지막 인덱스 요소들이 한번씩 저장됨
	...
	public void searchName1() throws InputMismatchException{
		...
		System.out.print("찾으실 학생을 입력하세요 : ");
		String name = sc.next();
		boolean flag = false;
	...
	public void sortByName() {
		...
		// -> 이 메서드를 비교의 키로 사용하요 각 Student 객체를 비교하고 정렬함.
