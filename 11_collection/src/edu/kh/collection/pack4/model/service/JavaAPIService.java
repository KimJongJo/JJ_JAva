...
//		Integer wrap1 = new Integer(num1);
		...
		int num2 = wrap1; // 컴파일러 Auto Unboxing 수행 코드 추가
	...
	public void method2() {
		...
		long test1 =1234567890L;
		String change1 = test1 + ""; // long + String -> String
		
		// Wrapper Class 를 이용한 방법
		// -> 코드는 길지만 효율이 좋음
		int test2 = 400;
	 ...
	 *   
	 *   
	 *   - StringBuilder : Thread Safe 미제공 (비동기) - 여유 있을때 다음일도 하는것
	 ...
	 *   
	 *   
	 *   - StringBuffer : Thread Safe 제공 (동기) - 한 일이 다 끝나고 나서 다음일을 하는것
