...
public class MapService {
	...
	public void method1() {
		...
		System.out.println("(map.put 메서드)");
		...
		System.out.println("(map.get 메서드)");
		...
		System.out.println("(map.size 메서드)");
		...
		System.out.println("(map.remove 메서드)");
		...
		System.out.println("(map.clear, map.isEmpty 메서드)");
	...
	public void method2() {
		...
		// Set<K> Map.keySet() :
		// - Map에 있는 key만 뽑아내서 Set형태로 만들어 반환
	...
	public void method4() {
		...
		// DTO 대신 Map 활용하기
		// - Key는 무조건 String 사용하는게 좋음
		// - Value의 타입이 모두 다름
		//   -> Ojbect를 부모 타입 참조 변수로 활용
