...
public interface TodoListDAO {
	...
	/** 할 일 완료 여부 변경 DAO
	 * @param index
	 * @return 해당 index 요스의 완료 여부가 변경 되면 true
	 * 			index 요소가 없으면 false
	 */
...
//	void addTodo(List<Object> todo);
//	
//	void delete(String title);
//
//	void update(String title, int input, String update);
//
