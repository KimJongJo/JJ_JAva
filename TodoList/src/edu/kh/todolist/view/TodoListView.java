...
public class TodoListView {
	...
	// 필드
	private BufferedReader br = null; // 키보드 임력 스트림 참조변수
...
//	private Scanner sc = new Scanner(System.in);
	...
	public TodoListView() {
		...
		// 객체 생성 시 발생되는 예외를 여기에 모아서 처리할 예정
		try {
			// 부모타입 참조변수 = 자식 객체
...
//		System.out.println("완료 여부 : " + completeYn + "\n");
...
//		System.out.println("완료 할 Todo 제목 : ");
//		String title = sc.nextLine();
//		
...
//		
//		System.out.print("업데이트 할 Todo 제목 : ");
//		String title = sc.nextLine();
//		
//		System.out.println("무엇을 수정 하시겠습니까? ");
//		System.out.println("1. 제목");
//		System.out.println("2. 세부 내용");
//		System.out.println("3. 완료 여부");
//		
//		System.out.print(">>>  ");
...
//		
//		service.update(title, input, update);
//		
//		
//	}
//	
	...
	public void todoUpdate() throws Exception {
		...
		String title = br.readLine();
		System.out.println("수정할 내용 작성 (입력 종료 시 !wq 작성 후 엔터)");
		System.out.println("----------------------------------------------");
